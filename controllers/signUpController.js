...
const validateUser = [
    body('username')
        ...
        .isLength({ max: 50 }).withMessage('Username must be less than 50 characters long'),
    body('email')
        .trim()
    ...
    body('password')
        .trim()
        .isLength({ min: 4, max: 16}).withMessage('Password must be between 4 and 16 characters long')
